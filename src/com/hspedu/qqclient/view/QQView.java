...
public class QQView {
    ...
    private MessageClientService messageClientService = new MessageClientService();//该对象用于用户私聊/群聊
                        ...
                        while (loop) {
                            ...
                            switch (key) {
                                ...
                                case "4":
                                    ...
                                    System.out.print("请输入发送文件的路径(形式：d:\\xxx.jpg)：");
                                    String src = Utility.readString(100);
                                    System.out.print("请输入把文件发送到对方的路径(形式：d:\\xxx.jpg)：");
